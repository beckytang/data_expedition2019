...
The data that students see in their statistics courses are often constrained to numeric and tabular data. However, there is an exciting field of data science and statistics known as text analysis. This expedition introduces students to the concept of treating text as data frames of words, and demonstrates how to perform basic analyses on bodies of text using R. Tweets from four 2020 Democratic Presidentital Primary candidates are used as data, and text analysis techniques demonstrated in the expedition include comparisons of word frequencies, log-odds ratios for word usage, and pairwise word correlations. 
...
The State of the Union address data used during the in-class exercise were obtained from The American Presidency Project (https://www.presidency.ucsb.edu/). There are four columns in the dataset: President, year, a sentence from the address, and the line number of that sentence. 
