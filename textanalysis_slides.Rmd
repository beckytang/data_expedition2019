...
## Moving beyond one-word tokens

- We do not have to constrain ourselves to one-word tokens. In fact, we can tokenize text into consecutive sequences of words called \textbf{n-grams}
