...
```{r paragraph_logit_results,cache=F}
...
A Dirichlet-Multinomial distribution is the result of $n$ independent, discrete-outcomed trials (same as in the multinomial) except the success probability is drawn from a Dirichlet distribution with specified parameters. This is the same form as the posterior-predictive for our example. Thus, 
